...
You can pass this value through to another C function that expects a pointer of the same type, or you can use [koffi.decode()](memory#decode-to-js-values) function to decode pointer arguments.
