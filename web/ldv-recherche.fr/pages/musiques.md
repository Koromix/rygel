...
<div class="tabbar">
    ...
    <a href="/musiques" class="active" title="Musiques"><img src="{{ ASSET ../../src/ludivine/assets/ui/music.png }}" alt="Musiques" /></a>
...
<div class="tab">
    <div class="cardset">
        <div class="card">
            <img src="{{ ASSET static/resources/musique_blueoctober.jpg }}" alt="" />
            <div>
        ...
        <div class="card">
            <img src="{{ ASSET static/resources/musique_gherbo.jpg }}" alt="" />
            <div>
        ...
        <div class="card">
            <img src="{{ ASSET static/resources/musique_jamesarthur.jpg }}" alt="" />
            <div>
        ...
        <div class="card">
            <img src="{{ ASSET static/resources/musique_thecranberries.jpg }}" alt="" />
            <div>
        ...
        <div class="card">
            <img src="{{ ASSET static/resources/musique_ladygaga.jpg }}" alt="" />
            <div>
    ...
    <button id="randomize" onclick="app.randomCard('.cardset')"><img src="{{ ASSET ../../src/ludivine/assets/ui/dice.webp }}" alt="Choix aléatoire" title="Choix aléatoire" /></button>
</div>
