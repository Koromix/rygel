...
<div class="tabbar">
    <a href="/videos" class="active" title="Vidéos"><img src="{{ ASSET ../../src/ludivine/assets/ui/video.png }}" alt="Vidéos" /></a>
...
<div class="tab">
    <div class="cardset">
        <div class="card">
            <img src="{{ ASSET static/resources/video_cn2r.jpg }}" alt="" />
            <div>
        ...
        <div class="card">
            <img src="{{ ASSET static/resources/video_legriguer.jpg }}" alt="" />
            <div>
        ...
        <div class="card">
            <img src="{{ ASSET static/resources/video_fenvac.jpg }}" alt="" />
            <div>
