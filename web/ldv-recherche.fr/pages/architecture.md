...
<div class="columns">
    <img src="{{ ASSET static/architecture/fr/signup.svg }}" width="800" height="550" alt=""/>
</div>
...
<div class="columns">
    <img src="{{ ASSET static/architecture/fr/login.svg }}" width="800" height="572" alt=""/>
</div>
...
> [!NOTE]
> Lors de la première connexion, le serveur ne possède pas de *vault* et retourne une erreur 204. La responsabilité de générer ce coffre-fort revient au client. C'est également le client qui effectue les opérations de migration du schéma de données SQLite en cas de besoin (par exemple après une mise à jour).
...
<div class="columns">
    <img src="{{ ASSET static/architecture/fr/data.svg }}" width="800" height="543" alt=""/>
</div>
