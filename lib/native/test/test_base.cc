...
TEST_FUNCTION("base/LocalDate")
{
#define WEEKDAY(Str, WeekDay) \
        do { \
            LocalDate date; \
            TEST(ParseDate((Str), &date)); \
            int weekday = date.IsoWeekDay(); \
            TEST_EX(weekday == (WeekDay), "%1: weekday %2, expected %3", (Str), weekday, (WeekDay)); \
        } while (false)

    // Random list generated with Python, with isoweekday()
    WEEKDAY("2111-02-26", 4);
    WEEKDAY("2144-03-22", 7);
    WEEKDAY("2015-12-03", 4);
    WEEKDAY("2177-03-29", 6);
    WEEKDAY("2078-09-21", 3);
    WEEKDAY("1947-10-27", 1);
    WEEKDAY("2028-02-13", 7);
    WEEKDAY("2171-01-18", 5);
    WEEKDAY("2037-10-06", 2);
    WEEKDAY("1938-11-16", 3);
    WEEKDAY("1950-05-29", 1);
    WEEKDAY("2017-05-09", 2);
    WEEKDAY("2194-07-15", 2);
    WEEKDAY("2006-07-03", 1);
    WEEKDAY("2015-02-11", 3);
    WEEKDAY("1984-11-26", 1);
    WEEKDAY("2147-12-14", 4);
    WEEKDAY("1915-08-03", 2);
    WEEKDAY("1902-10-11", 6);
    WEEKDAY("1953-01-06", 2);
    WEEKDAY("2070-03-19", 3);
    WEEKDAY("2083-11-27", 6);
    WEEKDAY("2116-02-27", 4);
    WEEKDAY("1995-04-09", 7);
    WEEKDAY("2193-05-26", 7);
    WEEKDAY("2101-01-20", 4);
    WEEKDAY("2025-07-25", 5);
    WEEKDAY("2136-09-06", 4);
    WEEKDAY("2148-05-03", 5);
    WEEKDAY("1940-11-09", 6);
    WEEKDAY("2064-12-08", 1);
    WEEKDAY("2108-01-29", 7);
    WEEKDAY("2100-04-19", 1);
    WEEKDAY("2022-12-11", 7);
    WEEKDAY("2133-03-19", 4);
    WEEKDAY("1971-03-04", 4);
    WEEKDAY("2188-08-31", 7);
    WEEKDAY("1929-10-08", 2);
    WEEKDAY("2189-04-25", 6);
    WEEKDAY("2071-07-26", 7);
    WEEKDAY("2155-11-15", 6);
    WEEKDAY("2063-04-13", 5);
    WEEKDAY("2198-09-07", 5);
    WEEKDAY("2080-11-30", 6);
    WEEKDAY("1944-07-22", 6);
    WEEKDAY("2017-09-23", 6);
    WEEKDAY("2152-12-07", 4);
    WEEKDAY("2055-06-20", 7);
    WEEKDAY("2080-04-06", 6);
    WEEKDAY("2115-08-08", 4);
    WEEKDAY("2028-08-05", 6);
    WEEKDAY("2114-09-09", 7);
    WEEKDAY("2041-10-01", 2);
    WEEKDAY("2098-12-29", 1);
    WEEKDAY("2056-04-28", 5);
    WEEKDAY("1930-05-29", 4);
    WEEKDAY("2136-07-21", 6);
    WEEKDAY("1908-02-10", 1);
    WEEKDAY("2138-09-06", 6);
    WEEKDAY("1902-12-05", 5);
    WEEKDAY("2076-09-07", 1);
    WEEKDAY("2008-01-29", 2);
    WEEKDAY("2157-02-03", 4);
    WEEKDAY("1927-10-22", 6);
    WEEKDAY("2134-06-16", 3);
    WEEKDAY("2157-03-12", 6);
    WEEKDAY("1963-03-28", 4);
    WEEKDAY("2030-09-17", 2);
    WEEKDAY("2138-08-27", 3);
    WEEKDAY("2006-03-13", 1);
    WEEKDAY("1932-10-12", 3);
    WEEKDAY("2163-08-06", 6);
    WEEKDAY("2152-12-12", 2);
    WEEKDAY("2037-01-06", 2);
    WEEKDAY("2187-09-29", 6);
    WEEKDAY("1903-03-09", 1);
    WEEKDAY("2055-02-19", 5);
    WEEKDAY("1909-06-18", 5);
    WEEKDAY("1935-12-01", 7);
    WEEKDAY("2159-05-29", 2);
    WEEKDAY("2021-08-03", 2);
    WEEKDAY("2159-12-16", 7);
    WEEKDAY("2042-10-20", 1);
    WEEKDAY("1916-12-29", 5);
    WEEKDAY("1901-04-24", 3);
    WEEKDAY("1991-03-30", 6);
    WEEKDAY("1999-05-13", 4);
    WEEKDAY("2082-05-16", 6);
    WEEKDAY("2187-07-04", 3);
    WEEKDAY("2060-06-20", 7);
    WEEKDAY("2040-06-20", 3);
    WEEKDAY("1990-11-14", 3);
    WEEKDAY("2044-08-03", 3);
    WEEKDAY("2072-12-07", 3);
    WEEKDAY("2002-07-19", 5);
    WEEKDAY("2089-01-07", 5);
    WEEKDAY("2082-12-13", 7);
    WEEKDAY("2071-11-13", 5);
    WEEKDAY("2129-07-25", 1);
    WEEKDAY("2000-07-30", 7);
    WEEKDAY("2119-12-15", 5);
    WEEKDAY("2146-11-10", 4);
    WEEKDAY("1969-05-13", 2);
    WEEKDAY("2091-03-25", 7);
    WEEKDAY("1986-07-14", 1);
    WEEKDAY("2005-12-03", 6);
    WEEKDAY("2068-07-14", 6);
    WEEKDAY("2088-04-06", 2);
    WEEKDAY("2009-06-12", 5);
    WEEKDAY("2168-07-10", 7);
    WEEKDAY("2166-12-22", 1);
    WEEKDAY("2011-02-14", 1);
    WEEKDAY("1986-06-29", 7);
    WEEKDAY("2193-09-21", 6);
    WEEKDAY("2061-05-28", 6);
    WEEKDAY("1962-04-16", 1);
    WEEKDAY("2116-11-27", 5);
    WEEKDAY("1980-06-30", 1);
    WEEKDAY("2069-07-22", 1);
    WEEKDAY("1936-01-25", 6);
    WEEKDAY("2001-06-05", 2);
    WEEKDAY("2196-12-01", 4);
    WEEKDAY("2034-07-05", 3);
    WEEKDAY("2119-03-28", 2);
    WEEKDAY("2026-04-17", 5);
    WEEKDAY("1985-04-24", 3);
    WEEKDAY("1946-03-11", 1);
    WEEKDAY("1925-03-04", 3);
    WEEKDAY("1971-11-20", 6);
    WEEKDAY("2028-03-31", 5);
    WEEKDAY("2161-02-18", 3);
    WEEKDAY("2092-02-09", 6);
    WEEKDAY("1943-08-28", 6);
    WEEKDAY("1938-04-06", 3);
    WEEKDAY("2139-04-29", 3);
    WEEKDAY("2112-03-09", 3);
    WEEKDAY("2188-05-26", 1);
    WEEKDAY("1914-08-16", 7);
    WEEKDAY("2110-07-30", 3);
    WEEKDAY("2101-09-19", 1);
    WEEKDAY("1985-05-21", 2);
    WEEKDAY("2134-04-16", 5);
    WEEKDAY("1985-01-23", 3);
    WEEKDAY("1949-04-26", 2);
    WEEKDAY("2153-09-22", 6);
    WEEKDAY("2038-06-04", 5);
    WEEKDAY("2055-02-10", 3);
    WEEKDAY("2068-11-29", 4);
    WEEKDAY("2094-09-23", 4);
    WEEKDAY("2126-03-20", 3);
    WEEKDAY("2102-11-16", 4);
    WEEKDAY("2004-12-02", 4);
    WEEKDAY("1999-11-23", 2);
    WEEKDAY("1972-04-29", 6);
    WEEKDAY("2009-06-09", 2);
    WEEKDAY("2099-07-27", 1);
    WEEKDAY("1928-10-14", 7);
    WEEKDAY("2144-07-21", 2);
    WEEKDAY("2146-11-15", 2);
    WEEKDAY("1966-07-15", 5);
    WEEKDAY("2061-08-31", 3);
    WEEKDAY("2177-06-26", 4);
    WEEKDAY("1926-11-19", 5);
    WEEKDAY("1937-09-09", 4);
    WEEKDAY("1976-07-14", 3);
    WEEKDAY("2056-10-04", 3);
    WEEKDAY("2102-12-17", 7);
    WEEKDAY("2174-07-11", 1);
    WEEKDAY("2059-04-12", 6);
    WEEKDAY("2158-09-16", 6);
    WEEKDAY("2081-02-12", 3);
    WEEKDAY("2161-09-06", 7);
    WEEKDAY("2146-09-22", 4);
    WEEKDAY("2061-06-05", 7);
    WEEKDAY("1996-12-04", 3);
    WEEKDAY("1978-04-26", 3);
    WEEKDAY("2182-07-11", 4);
    WEEKDAY("2117-04-02", 5);
    WEEKDAY("2110-06-18", 3);
    WEEKDAY("2009-06-06", 6);
    WEEKDAY("2153-05-21", 1);
    WEEKDAY("1920-06-10", 4);
    WEEKDAY("2009-11-10", 2);
    WEEKDAY("1972-01-04", 2);
    WEEKDAY("2132-06-15", 7);
    WEEKDAY("2071-02-28", 6);
    WEEKDAY("2131-04-30", 1);
    WEEKDAY("2039-06-11", 6);
    WEEKDAY("1925-06-14", 7);
    WEEKDAY("1913-02-28", 5);
    WEEKDAY("1920-01-26", 1);
    WEEKDAY("2074-12-07", 5);
    WEEKDAY("1931-05-25", 1);
    WEEKDAY("2052-02-12", 1);
    WEEKDAY("2030-09-06", 5);
    WEEKDAY("2083-05-02", 7);
    WEEKDAY("1951-09-27", 4);
    WEEKDAY("2156-11-02", 2);
    WEEKDAY("2191-04-26", 2);
    WEEKDAY("2028-07-28", 5);
...
TEST_FUNCTION("base/NormalizePath")
{
