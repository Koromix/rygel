...
const SABFS = new function () {
    this.init = async function (max_size) {
        try {
            await promiser({ type: 'sabfs.init', args: [max_size] });
        } catch (e) {
            throw e.value;
        }
    };
    ...
    this.write = async function (name, sab) {
        try {
            await promiser({ type: 'sabfs.write', args: [name, sab] });
        } catch (e) {
            throw e.value;
        }
    };
    ...
    this.shrink = async function (name) {
        try {
            let ret = await promiser({ type: 'sabfs.shrink', args: [name] });
            return ret.value;
        } catch (e) {
            throw e.value;
        }
