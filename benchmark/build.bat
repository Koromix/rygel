...
echo Building atoi_cc (Clang)...
clang -O2 -std=c++17 -Wall -I. -DNDEBUG -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_DEPRECATE benchmark\atoi_cc.cc vendor\libcc\libcc.cc -o benchmark\atoi_cc.exe -lws2_32 -ladvapi32 -lshell32 -lole32
