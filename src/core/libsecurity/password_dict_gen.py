...
static const uint32_t sec_DictWords[] = {""")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description = 'Create password_dict.hh (libsecurity) from dictionaries')
