...
int HandleConnect(const http_RequestInfo &request, const User *user, http_Response *out_response);
int HandleDisconnect(const http_RequestInfo &request, const User *user, http_Response *out_response);
