...
function run(form) {
    ...
    form.section("Situation actuelle", () => {
    ...
    form.section("Langues de vos parents", () => {
    ...
    form.section("Connaissance du programme Ligne de Vie ?", () => {
