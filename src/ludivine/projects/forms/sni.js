...
function run(form, values) {
    ...
    form.block(() => {
        ...
        form.enum("*q3a", "Voyez-vous ou parlez-vous au téléphone avec l'un de vos parents au moins une fois toutes les deux semaines ?", [
            [0, "Aucun des deux"],
            [1, "Mère uniquement"],
            [2, "Père uniquement"],
            [3, "Tous les deux"]
    ...
    form.block(() => {
        ...
        form.enum("*q4a", "Voyez-vous ou parlez-vous au téléphone avec l'un des parents de votre partenaire au moins une fois toutes les deux semaines ?", [
            [0, "Aucun des deux"],
            [1, "Mère uniquement"],
            [2, "Père uniquement"],
            [3, "Tous les deux"]
    ...
    form.block(() => {
        ...
        form.enum("*q5a", "Combien de ces membres de votre famille voyez-vous ou avez-vous au téléphone au moins une fois toutes les deux semaines ?", [0, 1, 2, 3, 4, 5, 6, [7, "7 ou plus"]], { disabled: !values.q5 })
    ...
    form.block(() => {
        ...
        form.enum("*q6a", "Combien de ces amis voyez-vous ou avec combien parlez-vous au moins une fois toutes les deux semaines ?", [0, 1, 2, 3, 4, 5, 6, [7, "7 ou plus"]], { disabled: !values.q6 })
    ...
    form.block(() => {
        ...
        form.enum("*q8a", "Avec combien de camarades de classe ou d'enseignants discutez-vous au moins une fois toutes les deux semaines ?", [0, 1, 2, 3, 4, 5, 6, [7, "7 ou plus"]], {
    ...
    form.block(() => {
        ...
        form.enum("*q9a", "Combien de collaborateurs encadrez-vous ?", [0, 1, 2, 3, 4, 5, 6, [7, "7 ou plus"]], { disabled: !values.q9 })
