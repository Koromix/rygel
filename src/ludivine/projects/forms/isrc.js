...
let intro = html`
    <p>Lorsque quelque chose de grave ou d'effrayant se produit, les gens peuvent avoir des <b>pensées ou des sentiments différents</b>. Vous nous avez expliqué un peu ce qui vous arrivé.
