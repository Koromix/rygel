...
static void SendDefaultPicture(http_IO *io)
{
    ...
    const AssetInfo *DefaultPicture = FindEmbedAsset("src/redropp/assets/ui/anonymous.png");
    K_ASSERT(DefaultPicture);
#else
    static const AssetInfo *DefaultPicture = FindEmbedAsset("src/redropp/assets/ui/anonymous.png");
    K_ASSERT(DefaultPicture);
#endif
