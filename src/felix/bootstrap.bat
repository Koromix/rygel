...
if NOT ERRORLEVEL 1 (
    ...
    if NOT ERRORLEVEL 1 (
        ...
        mkdir %BUILD%
        clang-cl /nologo /std:c++latest /I../.. /W0 /EHsc /MP /DNDEBUG /DNOMINMAX /DWINVER=0x0601 /D_WIN32_WINNT=0x0601 /DUNICODE /D_UNICODE /DLIBCC_NO_MINIZ /DLIBCC_NO_BROTLI /DLIBCC_NO_LZ4 /c %SRC% /Fo%BUILD%\
    ...
    mkdir %BUILD%
    cl /nologo /std:c++latest /I../.. /W0 /EHsc /MP /DNDEBUG /DNOMINMAX /DWINVER=0x0601 /D_WIN32_WINNT=0x0601 /DUNICODE /D_UNICODE /DLIBCC_NO_MINIZ /DLIBCC_NO_BROTLI /DLIBCC_NO_LZ4 /c %SRC% /Fo%BUILD%\
...
if NOT ERRORLEVEL 1 (
    ...
    mkdir %BUILD%
    g++ -std=gnu++2a -O0 -I../.. -DNDEBUG -DNOMINMAX  -DWINVER=0x0601 -D_WIN32_WINNT=0x0601 -DUNICODE -D_UNICODE -DLIBCC_NO_MINIZ -DLIBCC_NO_BROTLI -DLIBCC_NO_LZ4 %SRC% -lws2_32 -ladvapi32 -lshell32 -lole32 -luuid -w -o%BUILD%\felix.exe
    %BUILD%\felix.exe --no_presets --features=OptimizeSpeed,StaticLink -O %BUILD%\Fast felix
    move %BUILD%\Fast\felix.exe %BIN%
