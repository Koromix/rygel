...
set SRC=*.cc ..\..\lib\native\base\base.cc ..\..\lib\native\compress\miniz.cc ..\..\lib\native\wrap\json.cc ^
...
if NOT ERRORLEVEL 1 (
    ...
    lld-link /nologo %TEMP%\*.obj ws2_32.lib advapi32.lib shell32.lib ole32.lib user32.lib userenv.lib /out:%TEMP%\felix.exe
...
if NOT ERRORLEVEL 1 (
    ...
    link /nologo %TEMP%\*.obj ws2_32.lib advapi32.lib shell32.lib ole32.lib user32.lib userenv.lib /out:%TEMP%\felix.exe
    %TEMP%\felix.exe -pFast felix %*
    copy %BUILD%\felix.exe %BINARY% >NUL
...
if NOT ERRORLEVEL 1 (
    ...
    mkdir %TEMP%
    g++ -std=gnu++17 -O0 -I../.. -DNDEBUG -DNOMINMAX  -DWINVER=0x0601 -D_WIN32_WINNT=0x0601 -DUNICODE -D_UNICODE %SRC% -lws2_32 -ladvapi32 -lshell32 -lole32 -luser32 -luuid -luserenv -w -o%TEMP%\felix.exe
    %TEMP%\felix.exe -pFast felix %*
    copy %BUILD%\felix.exe %BINARY% >NUL
