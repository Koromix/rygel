data.makeFormHeader("PDAS", page)
form.output(html`
    <p>L’échelle d’évaluation de la dépression psychotique</p>
    <p>1 => pas du tout ; 2=> un peu ; 3 => parfois ; 4 =>souvent ; 5 => très souvent</p>
`)

form.pushOptions({mandatory: true, missingMode: 'disable'})

form.enumRadio("symptomesSomatiques", "1- Symptômes somatiques – généraux", [
    [1, "1: Absent"],
...
form.enumRadio("travailEtActivites", "2- Travail et activités", [
...
form.enumRadio("humeurDepressive", "3- Humeur dépressive ", [
    [1, "1: Absente"],
...
form.enumRadio("anxietePsychique", "4- Anxiété psychique ", [
    [1, "1: Absente"],
...
form.enumRadio("sentimentsDeCulpabilite", "5- Sentiments de culpabilité  ", [
    [1, "1: Absent"],
...
form.enumRadio("ralentissementPsychomoteur", "6- Ralentissement psychomoteur  ", [
    [1, "1: Absent"],
...
form.enumRadio("retraitEmotionnel", "7- Retrait émotionnel ", [
    [1, "1: Absent"],
...
form.enumRadio("mefiance", "8- Méfiance ", [
    [1, "1: Absente"],
...
form.enumRadio("hallucinations", "9- Hallucinations ", [
    [1, "1: Absente"],
...
form.enumRadio("penseesInhabituelles", "10- Pensées inhabituelles  ", [
    [1, "1: Absente"],
...
form.enumRadio("emoussementDesAffects", "11- Émoussement des affects ", [
    [1, "1: Absent"],
