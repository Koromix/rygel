...
form.section("Données démographiques", () => {form.text("Prenom", "Prénom ?", {mandatory: true})
form.text("nom", "Nom ?", {mandatory: true})
let sexe = form.choice("sexe", "Sexe ?", [["Homme"], ["Femme"]])
if (sexe.value == "Femme") {
...
form.text("date", "Date de consult?")
let motif = form.dropdown("motif", "Motif de consult ?", [
...
let contexte = form.dropdown("contexte", "Dans un contexte de ?", [
...
form.radio("situation_perso", "Situation personnelle", [
    ["couple", "Couple"],
    ["marié", "Marié"],
    ["séparé", "Séparé"],
    ["veuf", "veuf"]
