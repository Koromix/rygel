...
private:
    ...
    bool PushArray(const Napi::Array &array, const TypeInfo *type, uint8_t *dest, int16_t realign = 0);
    ...
    Napi::Array PopArray(const uint8_t *src, const TypeInfo *type, int16_t realign = 0);
};
