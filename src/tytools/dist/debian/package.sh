...
package() {
    install -D -m0755 ${BUILD_DIR}/bin/Fast/tycmd ${ROOT_DIR}/usr/bin/tycmd
    install -D -m0755 ${BUILD_DIR}/bin/Fast/tycommander ${ROOT_DIR}/usr/bin/tycommander
    install -D -m0755 ${BUILD_DIR}/bin/Fast/tyuploader ${ROOT_DIR}/usr/bin/tyuploader
