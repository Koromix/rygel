...
SCRIPT_PATH=src/heimdall/dist/rpm/heimdall.sh
...
build() {
    ...
    install -D -m0644 src/heimdall/dist/rpm/heimdall.ini ${ROOT_DIR}/etc/heimdall.ini
    install -D -m0644 src/heimdall/dist/rpm/heimdall.service ${ROOT_DIR}/usr/lib/systemd/system/heimdall.service
