...
hm_add_events <- function(inst, events) {
    .Call(`hmR_AddEvents`, inst, events)
}

hm_add_periods <- function(inst, periods) {
    .Call(`hmR_AddPeriods`, inst, periods)
}

hm_add_values <- function(inst, values) {
    .Call(`hmR_AddValues`, inst, values)
}
