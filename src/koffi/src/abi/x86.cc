...
bool AnalyseFunction(Napi::Env env, InstanceData *instance, FunctionInfo *func)
{
    ...
    for (ParameterInfo &param: func->parameters) {
        ...
        if (param.type->primitive == PrimitiveKind::Record || param.type->primitive == PrimitiveKind::Union) {
            func->sync.Append({ .op = Code2Op(AbiOpcode::PushAggregateStack), .a = param.offset, .b1 = (int16_t)(offset * 4), .type = param.type });
            func->async.Append({ .op = Code2Op(AbiOpcode::PushAggregateStack), .a = param.offset, .b1 = (int16_t)(offset * 4), .type = param.type });
        } else {
    ...
    switch (func->ret.type->primitive) {
        ...
        case PrimitiveKind::Callback: {
            ...
            // Async
            {
                ...
                AbiOpcode call = fast ? AbiOpcode::CallGX : AbiOpcode::CallG;
        ...
        case PrimitiveKind::Union: {
            ...
            if (func->ret.type->members.len == 1) {
                ...
                if (member.type->primitive == PrimitiveKind::Float32) {
                    AbiOpcode run = fast ? AbiOpcode::RunAggregateFX : AbiOpcode::RunAggregateF;
                    AbiOpcode call = fast ? AbiOpcode::CallFX : AbiOpcode::CallF;
                    ...
                    AbiOpcode run = fast ? AbiOpcode::RunAggregateDX : AbiOpcode::RunAggregateD;
                    AbiOpcode call = fast ? AbiOpcode::CallDX : AbiOpcode::CallD;
            ...
            if (func->ret.abi.regular) {
                AbiOpcode run = fast ? AbiOpcode::RunAggregateGX : AbiOpcode::RunAggregateG;
                AbiOpcode call = fast ? AbiOpcode::CallGX : AbiOpcode::CallG;
                ...
                AbiOpcode run = fast ? AbiOpcode::RunAggregateMemX : AbiOpcode::RunAggregateMem;
                AbiOpcode call = fast ? AbiOpcode::CallMemX : AbiOpcode::CallMem;
        ...
        case PrimitiveKind::Float32: {
            AbiOpcode run = fast ? AbiOpcode::RunFloat32X : AbiOpcode::RunFloat32;
            AbiOpcode call = fast ? AbiOpcode::CallFX : AbiOpcode::CallF;
        ...
        case PrimitiveKind::Float64: {
            AbiOpcode run = fast ? AbiOpcode::RunFloat64X : AbiOpcode::RunFloat64;
            AbiOpcode call = fast ? AbiOpcode::CallDX : AbiOpcode::CallD;
