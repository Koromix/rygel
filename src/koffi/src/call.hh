...
struct alignas(8) CallData {
    ...
    bool PushNormalArray(napi_value array, const TypeInfo *type, Size size, uint8_t *origin);
    ...
    Size PushIndirectString(napi_value array, const TypeInfo *ref, void **out_ptr);
