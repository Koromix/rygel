...
static const uint32_t UserPermissionMasterMask = 0b0000000000111u;
static const uint32_t UserPermissionSlaveMask =  0b1111111111000u;
static const uint32_t LegacyPermissionMask =     0b1100100011111u;
