...
SCRIPT_PATH=src/goupile/dist/rpm/goupile.sh
...
build() {
    ...
    install -D -m0755 src/goupile/dist/rpm/manage.py ${ROOT_DIR}/usr/lib/goupile/manage.py
    install -D -m0755 src/goupile/dist/rpm/generator.py ${ROOT_DIR}/usr/lib/goupile/generator.py
    ...
    install -D -m0644 src/goupile/dist/rpm/README.md ${ROOT_DIR}/etc/goupile/domains.d/README.md
    install -D -m0644 src/goupile/server/config.ini ${ROOT_DIR}/etc/goupile/template.ini
    install -D -m0644 src/goupile/dist/rpm/goupile@.service ${ROOT_DIR}/usr/lib/systemd/system/goupile@.service
