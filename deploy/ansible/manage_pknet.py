...
def load_inventories(path):
    ...
    with open(path + '/host_vars/host1/nginx.yml', 'r') as f:
        nginx = yaml.load(f)
    with open(path + '/host_vars/host1/goupile.yml', 'r') as f:
        goupile = yaml.load(f)
...
def save_inventories(path, nginx, goupile):
    ...
    with open(path + '/host_vars/host1/nginx.yml', 'w') as f:
        yaml.dump(nginx, f)
    with open(path + '/host_vars/host1/goupile.yml', 'w') as f:
        yaml.dump(goupile, f)
