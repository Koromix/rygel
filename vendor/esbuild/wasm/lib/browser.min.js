...
`);function Fe(e,t){return e[t++]|e[t++]<<8|e[t++]<<16|e[t++]<<24}function Ce(e,t,n){e[n++]=t,e[n++]=t>>8,e[n++]=t>>16,e[n++]=t>>24}var _=JSON.stringify,Te="warning",De="silent";function pe(e,t){let n=[];for(let i of e){if(Y(i,t),i.indexOf(",")>=0)throw new Error(`Invalid ${t}: ${i}`);n.push(i)}return n.join(",")}var ve=()=>null,I=e=>typeof e=="boolean"?null:"a boolean",m=e=>typeof e=="string"?null:"a string",Re=e=>e instanceof RegExp?null:"a RegExp object",ue=e=>typeof e=="number"&&e===(e|0)?null:"an integer",nt=e=>typeof e=="number"&&e===(e|0)&&e>=0&&e<=65535?null:"a valid port number",je=e=>typeof e=="function"?null:"a function",le=e=>Array.isArray(e)?null:"an array",Q=e=>Array.isArray(e)&&e.every(t=>typeof t=="string")?null:"an array of strings",G=e=>typeof e=="object"&&e!==null&&!Array.isArray(e)?null:"an object",rt=e=>typeof e=="object"&&e!==null?null:"an array or an object",it=e=>e instanceof WebAssembly.Module?null:"a WebAssembly.Module",Be=e=>typeof e=="object"&&!Array.isArray(e)?null:"an object or null",Le=e=>typeof e=="string"||typeof e=="boolean"?null:"a string or a boolean",lt=e=>typeof e=="string"||typeof e=="object"&&e!==null&&!Array.isArray(e)?null:"a string or an object",Ne=e=>typeof e=="string"||Array.isArray(e)&&e.every(t=>typeof t=="string")?null:"a string or an array of strings",qe=e=>typeof e=="string"||e instanceof Uint8Array?null:"a string or a Uint8Array",st=e=>typeof e=="string"||e instanceof URL?null:"a string or a URL";function r(e,t,n,i){let a=e[n];if(t[n+""]=!0,a===void 0)return;let l=i(a);if(l!==null)throw new Error(`${_(n)} must be ${l}`);return a}function K(e,t,n){for(let i in e)if(!(i in t))throw new Error(`Invalid option ${n}: ${_(i)}`)}function Ie(e){let t=Object.create(null),n=r(e,t,"wasmURL",st),i=r(e,t,"wasmModule",it),a=r(e,t,"worker",I);return K(e,t,"in initialize() call"),{wasmURL:n,wasmModule:i,worker:a}}function We(e){let t;if(e!==void 0){t=Object.create(null);for(let n in e){let i=e[n];if(typeof i=="string"||i===!1)t[n]=i;else throw new Error(`Expected ${_(n)} in mangle cache to map to either a string or false`)}}return t}function Oe(e,t,n,i,a){let l=r(t,n,"color",I),g=r(t,n,"logLevel",m),s=r(t,n,"logLimit",ue);l!==void 0?e.push(`--color=${l}`):i&&e.push("--color=true"),e.push(`--log-level=${g||a}`),e.push(`--log-limit=${s||0}`)}function Y(e,t,n){if(typeof e!="string")throw new Error(`Expected value for ${t}${n!==void 0?" "+_(n):""} to be a string, got ${typeof e} instead`);return e}function ze(e,t,n){let i=r(t,n,"legalComments",m),a=r(t,n,"sourceRoot",m),l=r(t,n,"sourcesContent",I),g=r(t,n,"target",Ne),s=r(t,n,"format",m),d=r(t,n,"globalName",m),P=r(t,n,"mangleProps",Re),A=r(t,n,"reserveProps",Re),b=r(t,n,"mangleQuoted",I),j=r(t,n,"minify",I),T=r(t,n,"minifySyntax",I),L=r(t,n,"minifyWhitespace",I),N=r(t,n,"minifyIdentifiers",I),S=r(t,n,"lineLimit",ue),z=r(t,n,"drop",Q),V=r(t,n,"dropLabels",Q),w=r(t,n,"charset",m),p=r(t,n,"treeShaking",I),f=r(t,n,"ignoreAnnotations",I),o=r(t,n,"jsx",m),v=r(t,n,"jsxFactory",m),E=r(t,n,"jsxFragment",m),M=r(t,n,"jsxImportSource",m),B=r(t,n,"jsxDev",I),u=r(t,n,"jsxSideEffects",I),c=r(t,n,"define",G),h=r(t,n,"logOverride",G),k=r(t,n,"supported",G),F=r(t,n,"pure",Q),$=r(t,n,"keepNames",I),R=r(t,n,"platform",m),C=r(t,n,"tsconfigRaw",lt);if(i&&e.push(`--legal-comments=${i}`),a!==void 0&&e.push(`--source-root=${a}`),l!==void 0&&e.push(`--sources-content=${l}`),g&&e.push(`--target=${pe(Array.isArray(g)?g:[g],"target")}`),s&&e.push(`--format=${s}`),d&&e.push(`--global-name=${d}`),R&&e.push(`--platform=${R}`),C&&e.push(`--tsconfig-raw=${typeof C=="string"?C:JSON.stringify(C)}`),j&&e.push("--minify"),T&&e.push("--minify-syntax"),L&&e.push("--minify-whitespace"),N&&e.push("--minify-identifiers"),S&&e.push(`--line-limit=${S}`),w&&e.push(`--charset=${w}`),p!==void 0&&e.push(`--tree-shaking=${p}`),f&&e.push("--ignore-annotations"),z)for(let x of z)e.push(`--drop:${Y(x,"drop")}`);if(V&&e.push(`--drop-labels=${pe(V,"drop label")}`),P&&e.push(`--mangle-props=${xe(P)}`),A&&e.push(`--reserve-props=${xe(A)}`),b!==void 0&&e.push(`--mangle-quoted=${b}`),o&&e.push(`--jsx=${o}`),v&&e.push(`--jsx-factory=${v}`),E&&e.push(`--jsx-fragment=${E}`),M&&e.push(`--jsx-import-source=${M}`),B&&e.push("--jsx-dev"),u&&e.push("--jsx-side-effects"),c)for(let x in c){if(x.indexOf("=")>=0)throw new Error(`Invalid define: ${x}`);e.push(`--define:${x}=${Y(c[x],"define",x)}`)}if(h)for(let x in h){if(x.indexOf("=")>=0)throw new Error(`Invalid log override: ${x}`);e.push(`--log-override:${x}=${Y(h[x],"log override",x)}`)}if(k)for(let x in k){if(x.indexOf("=")>=0)throw new Error(`Invalid supported: ${x}`);let O=k[x];if(typeof O!="boolean")throw new Error(`Expected value for supported ${_(x)} to be a boolean, got ${typeof O} instead`);e.push(`--supported:${x}=${O}`)}if(F)for(let x of F)e.push(`--pure:${Y(x,"pure")}`);$&&e.push("--keep-names")}function ot(e,t,n,i,a){var ne;let l=[],g=[],s=Object.create(null),d=null,P=null;Oe(l,t,s,n,i),ze(l,t,s);let A=r(t,s,"sourcemap",Le),b=r(t,s,"bundle",I),j=r(t,s,"splitting",I),T=r(t,s,"preserveSymlinks",I),L=r(t,s,"metafile",I),N=r(t,s,"outfile",m),S=r(t,s,"outdir",m),z=r(t,s,"outbase",m),V=r(t,s,"tsconfig",m),w=r(t,s,"resolveExtensions",Q),p=r(t,s,"nodePaths",Q),f=r(t,s,"mainFields",Q),o=r(t,s,"conditions",Q),v=r(t,s,"external",Q),E=r(t,s,"packages",m),M=r(t,s,"alias",G),B=r(t,s,"loader",G),u=r(t,s,"outExtension",G),c=r(t,s,"publicPath",m),h=r(t,s,"entryNames",m),k=r(t,s,"chunkNames",m),F=r(t,s,"assetNames",m),$=r(t,s,"inject",Q),R=r(t,s,"banner",G),C=r(t,s,"footer",G),x=r(t,s,"entryPoints",rt),O=r(t,s,"absWorkingDir",m),U=r(t,s,"stdin",G),q=(ne=r(t,s,"write",I))!=null?ne:a,D=r(t,s,"allowOverwrite",I),J=r(t,s,"mangleCache",G);if(s.plugins=!0,K(t,s,`in ${e}() call`),A&&l.push(`--sourcemap${A===!0?"":`=${A}`}`),b&&l.push("--bundle"),D&&l.push("--allow-overwrite"),j&&l.push("--splitting"),T&&l.push("--preserve-symlinks"),L&&l.push("--metafile"),N&&l.push(`--outfile=${N}`),S&&l.push(`--outdir=${S}`),z&&l.push(`--outbase=${z}`),V&&l.push(`--tsconfig=${V}`),E&&l.push(`--packages=${E}`),w&&l.push(`--resolve-extensions=${pe(w,"resolve extension")}`),c&&l.push(`--public-path=${c}`),h&&l.push(`--entry-names=${h}`),k&&l.push(`--chunk-names=${k}`),F&&l.push(`--asset-names=${F}`),f&&l.push(`--main-fields=${pe(f,"main field")}`),o&&l.push(`--conditions=${pe(o,"condition")}`),v)for(let y of v)l.push(`--external:${Y(y,"external")}`);if(M)for(let y in M){if(y.indexOf("=")>=0)throw new Error(`Invalid package name in alias: ${y}`);l.push(`--alias:${y}=${Y(M[y],"alias",y)}`)}if(R)for(let y in R){if(y.indexOf("=")>=0)throw new Error(`Invalid banner file type: ${y}`);l.push(`--banner:${y}=${Y(R[y],"banner",y)}`)}if(C)for(let y in C){if(y.indexOf("=")>=0)throw new Error(`Invalid footer file type: ${y}`);l.push(`--footer:${y}=${Y(C[y],"footer",y)}`)}if($)for(let y of $)l.push(`--inject:${Y(y,"inject")}`);if(B)for(let y in B){if(y.indexOf("=")>=0)throw new Error(`Invalid loader extension: ${y}`);l.push(`--loader:${y}=${Y(B[y],"loader",y)}`)}if(u)for(let y in u){if(y.indexOf("=")>=0)throw new Error(`Invalid out extension: ${y}`);l.push(`--out-extension:${y}=${Y(u[y],"out extension",y)}`)}if(x)if(Array.isArray(x))for(let y=0,re=x.length;y<re;y++){let H=x[y];if(typeof H=="object"&&H!==null){let ee=Object.create(null),ie=r(H,ee,"in",m),X=r(H,ee,"out",m);if(K(H,ee,"in entry point at index "+y),ie===void 0)throw new Error('Missing property "in" for entry point at index '+y);if(X===void 0)throw new Error('Missing property "out" for entry point at index '+y);g.push([X,ie])}else g.push(["",Y(H,"entry point at index "+y)])}else for(let y in x)g.push([y,Y(x[y],"entry point",y)]);if(U){let y=Object.create(null),re=r(U,y,"contents",qe),H=r(U,y,"resolveDir",m),ee=r(U,y,"sourcefile",m),ie=r(U,y,"loader",m);K(U,y,'in "stdin" object'),ee&&l.push(`--sourcefile=${ee}`),ie&&l.push(`--loader=${ie}`),H&&(P=H),typeof re=="string"?d=Z(re):re instanceof Uint8Array&&(d=re)}let W=[];if(p)for(let y of p)y+="",W.push(y);return{entries:g,flags:l,write:q,stdinContents:d,stdinResolveDir:P,absWorkingDir:O,nodePaths:W,mangleCache:We(J)}}function at(e,t,n,i){let a=[],l=Object.create(null);Oe(a,t,l,n,i),ze(a,t,l);let g=r(t,l,"sourcemap",Le),s=r(t,l,"sourcefile",m),d=r(t,l,"loader",m),P=r(t,l,"banner",m),A=r(t,l,"footer",m),b=r(t,l,"mangleCache",G);return K(t,l,`in ${e}() call`),g&&a.push(`--sourcemap=${g===!0?"external":g}`),s&&a.push(`--sourcefile=${s}`),d&&a.push(`--loader=${d}`),P&&a.push(`--banner=${P}`),A&&a.push(`--footer=${A}`),{flags:a,mangleCache:We(b)}}function Ke(e){let t={},n={didClose:!1,reason:""},i={},a=0,l=0,g=new Uint8Array(16*1024),s=0,d=w=>{let p=s+w.length;if(p>g.length){let o=new Uint8Array(p*2);o.set(g),g=o}g.set(w,s),s+=w.length;let f=0;for(;f+4<=s;){let o=Fe(g,f);if(f+4+o>s)break;f+=4,L(g.subarray(f,f+o)),f+=o}f>0&&(g.copyWithin(0,f,s),s-=f)},P=w=>{n.didClose=!0,w&&(n.reason=": "+(w.message||w));let p="The service was stopped"+n.reason;for(let f in i)i[f](p,null);i={}},A=(w,p,f)=>{if(n.didClose)return f("The service is no longer running"+n.reason,null);let o=a++;i[o]=(v,E)=>{try{f(v,E)}finally{w&&w.unref()}},w&&w.ref(),e.writeToStdin(Ae({id:o,isRequest:!0,value:p}))},b=(w,p)=>{if(n.didClose)throw new Error("The service is no longer running"+n.reason);e.writeToStdin(Ae({id:w,isRequest:!1,value:p}))},j=(w,p)=>te(null,null,function*(){try{if(p.command==="ping"){b(w,{});return}if(typeof p.key=="number"){let f=t[p.key];if(!f)return;let o=f[p.command];if(o){yield o(w,p);return}}throw new Error("Invalid command: "+p.command)}catch(f){let o=[ae(f,e,null,void 0,"")];try{b(w,{errors:o})}catch(v){}}}),T=!0,L=w=>{if(T){T=!1;let f=String.fromCharCode(...w);if(f!=="0.25.6")throw new Error(`Cannot start service: Host version "0.25.6" does not match binary version ${_(f)}`);return}let p=Pe(w);if(p.isRequest)j(p.id,p.value);else{let f=i[p.id];delete i[p.id],p.value.error?f(p.value.error,{}):f(null,p.value)}};return{readFromStdout:d,afterClose:P,service:{buildOrContext:({callName:w,refs:p,options:f,isTTY:o,defaultWD:v,callback:E})=>{let M=0,B=l++,u={},c={ref(){++M===1&&p&&p.ref()},unref(){--M===0&&(delete t[B],p&&p.unref())}};t[B]=u,c.ref(),ut(w,B,A,b,c,e,u,f,o,v,(h,k)=>{try{E(h,k)}finally{c.unref()}})},transform:({callName:w,refs:p,input:f,options:o,isTTY:v,fs:E,callback:M})=>{let B=_e(),u=c=>{try{if(typeof f!="string"&&!(f instanceof Uint8Array))throw new Error('The input to "transform" must be a string or a Uint8Array');let{flags:h,mangleCache:k}=at(w,o,v,De),F={command:"transform",flags:h,inputFS:c!==null,input:c!==null?Z(c):typeof f=="string"?Z(f):f};k&&(F.mangleCache=k),A(p,F,($,R)=>{if($)return M(new Error($),null);let C=de(R.errors,B),x=de(R.warnings,B),O=1,U=()=>{if(--O===0){let q={warnings:x,code:R.code,map:R.map,mangleCache:void 0,legalComments:void 0};"legalComments"in R&&(q.legalComments=R==null?void 0:R.legalComments),R.mangleCache&&(q.mangleCache=R==null?void 0:R.mangleCache),M(null,q)}};if(C.length>0)return M(me("Transform failed",C,x),null);R.codeFS&&(O++,E.readFile(R.code,(q,D)=>{q!==null?M(q,null):(R.code=D,U())})),R.mapFS&&(O++,E.readFile(R.map,(q,D)=>{q!==null?M(q,null):(R.map=D,U())})),U()})}catch(h){let k=[];try{Oe(k,o,{},v,De)}catch($){}let F=ae(h,e,B,void 0,"");A(p,{command:"error",flags:k,error:F},()=>{F.detail=B.load(F.detail),M(me("Transform failed",[F],[]),null)})}};if((typeof f=="string"||f instanceof Uint8Array)&&f.length>1024*1024){let c=u;u=()=>E.writeFile(f,c)}u(null)},formatMessages:({callName:w,refs:p,messages:f,options:o,callback:v})=>{if(!o)throw new Error(`Missing second argument in ${w}() call`);let E={},M=r(o,E,"kind",m),B=r(o,E,"color",I),u=r(o,E,"terminalWidth",ue);if(K(o,E,`in ${w}() call`),M===void 0)throw new Error(`Missing "kind" in ${w}() call`);if(M!=="error"&&M!=="warning")throw new Error(`Expected "kind" to be "error" or "warning" in ${w}() call`);let c={command:"format-msgs",messages:se(f,"messages",null,"",u),isWarning:M==="warning"};B!==void 0&&(c.color=B),u!==void 0&&(c.terminalWidth=u),A(p,c,(h,k)=>{if(h)return v(new Error(h),null);v(null,k.messages)})},analyzeMetafile:({callName:w,refs:p,metafile:f,options:o,callback:v})=>{o===void 0&&(o={});let E={},M=r(o,E,"color",I),B=r(o,E,"verbose",I);K(o,E,`in ${w}() call`);let u={command:"analyze-metafile",metafile:f};M!==void 0&&(u.color=M),B!==void 0&&(u.verbose=B),A(p,u,(c,h)=>{if(c)return v(new Error(c),null);v(null,h.result)})}}}}function ut(e,t,n,i,a,l,g,s,d,P,A){let b=_e(),j=e==="context",T=(S,z)=>{let V=[];try{Oe(V,s,{},d,Te)}catch(p){}let w=ae(S,l,b,void 0,z);n(a,{command:"error",flags:V,error:w},()=>{w.detail=b.load(w.detail),A(me(j?"Context failed":"Build failed",[w],[]),null)})},L;if(typeof s=="object"){let S=s.plugins;if(S!==void 0){if(!Array.isArray(S))return T(new Error('"plugins" must be an array'),"");L=S}}if(L&&L.length>0){if(l.isSync)return T(new Error("Cannot use plugins in synchronous API calls"),"");ct(t,n,i,a,l,g,s,L,b).then(S=>{if(!S.ok)return T(S.error,S.pluginName);try{N(S.requestPlugins,S.runOnEndCallbacks,S.scheduleOnDisposeCallbacks)}catch(z){T(z,"")}},S=>T(S,""));return}try{N(null,(S,z)=>z([],[]),()=>{})}catch(S){T(S,"")}function N(S,z,V){let w=l.hasFS,{entries:p,flags:f,write:o,stdinContents:v,stdinResolveDir:E,absWorkingDir:M,nodePaths:B,mangleCache:u}=ot(e,s,d,Te,w);if(o&&!l.hasFS)throw new Error('The "write" option is unavailable in this environment');let c={command:"build",key:t,entries:p,flags:f,write:o,stdinContents:v,stdinResolveDir:E,absWorkingDir:M||P,nodePaths:B,context:j};S&&(c.plugins=S),u&&(c.mangleCache=u);let h=($,R)=>{let C={errors:de($.errors,b),warnings:de($.warnings,b),outputFiles:void 0,metafile:void 0,mangleCache:void 0},x=C.errors.slice(),O=C.warnings.slice();$.outputFiles&&(C.outputFiles=$.outputFiles.map(dt)),$.metafile&&(C.metafile=JSON.parse($.metafile)),$.mangleCache&&(C.mangleCache=$.mangleCache),$.writeToStdout!==void 0&&console.log(oe($.writeToStdout).replace(/\n$/,"")),z(C,(U,q)=>{if(x.length>0||U.length>0){let D=me("Build failed",x.concat(U),O.concat(q));return R(D,null,U,q)}R(null,C,U,q)})},k,F;j&&(g["on-end"]=($,R)=>new Promise(C=>{h(R,(x,O,U,q)=>{let D={errors:U,warnings:q};F&&F(x,O),k=void 0,F=void 0,i($,D),C()})})),n(a,c,($,R)=>{if($)return A(new Error($),null);if(!j)return h(R,(O,U)=>(V(),A(O,U)));if(R.errors.length>0)return A(me("Context failed",R.errors,R.warnings),null);let C=!1,x={rebuild:()=>(k||(k=new Promise((O,U)=>{let q;F=(J,W)=>{q||(q=()=>J?U(J):O(W))};let D=()=>{n(a,{command:"rebuild",key:t},(W,ne)=>{W?U(new Error(W)):q?q():D()})};D()})),k),watch:(O={})=>new Promise((U,q)=>{if(!l.hasFS)throw new Error('Cannot use the "watch" API in this environment');let D={},J=r(O,D,"delay",ue);K(O,D,"in watch() call");let W={command:"watch",key:t};J&&(W.delay=J),n(a,W,ne=>{ne?q(new Error(ne)):U(void 0)})}),serve:(O={})=>new Promise((U,q)=>{if(!l.hasFS)throw new Error('Cannot use the "serve" API in this environment');let D={},J=r(O,D,"port",nt),W=r(O,D,"host",m),ne=r(O,D,"servedir",m),y=r(O,D,"keyfile",m),re=r(O,D,"certfile",m),H=r(O,D,"fallback",m),ee=r(O,D,"cors",G),ie=r(O,D,"onRequest",je);K(O,D,"in serve() call");let X={command:"serve",key:t,onRequest:!!ie};if(J!==void 0&&(X.port=J),W!==void 0&&(X.host=W),ne!==void 0&&(X.servedir=ne),y!==void 0&&(X.keyfile=y),re!==void 0&&(X.certfile=re),H!==void 0&&(X.fallback=H),ee){let ge={},fe=r(ee,ge,"origin",Ne);K(ee,ge,'on "cors" object'),Array.isArray(fe)?X.corsOrigin=fe:fe!==void 0&&(X.corsOrigin=[fe])}n(a,X,(ge,fe)=>{if(ge)return q(new Error(ge));ie&&(g["serve-request"]=(Je,Ye)=>{ie(Ye.args),i(Je,{})}),U(fe)})}),cancel:()=>new Promise(O=>{if(C)return O();n(a,{command:"cancel",key:t},()=>{O()})}),dispose:()=>new Promise(O=>{if(C)return O();C=!0,n(a,{command:"dispose",key:t},()=>{O(),V(),a.unref()})})};a.ref(),A(null,x)})}}var ct=(e,t,n,i,a,l,g,s,d)=>te(null,null,function*(){let P=[],A=[],b={},j={},T=[],L=0,N=0,S=[],z=!1;s=[...s];for(let p of s){let f={};if(typeof p!="object")throw new Error(`Plugin at index ${N} must be an object`);let o=r(p,f,"name",m);if(typeof o!="string"||o==="")throw new Error(`Plugin at index ${N} is missing a name`);try{let v=r(p,f,"setup",je);if(typeof v!="function")throw new Error("Plugin is missing a setup function");K(p,f,`on plugin ${_(o)}`);let E={name:o,onStart:!1,onEnd:!1,onResolve:[],onLoad:[]};N++;let B=v({initialOptions:g,resolve:(u,c={})=>{if(!z)throw new Error('Cannot call "resolve" before plugin setup has completed');if(typeof u!="string")throw new Error("The path to resolve must be a string");let h=Object.create(null),k=r(c,h,"pluginName",m),F=r(c,h,"importer",m),$=r(c,h,"namespace",m),R=r(c,h,"resolveDir",m),C=r(c,h,"kind",m),x=r(c,h,"pluginData",ve),O=r(c,h,"with",G);return K(c,h,"in resolve() call"),new Promise((U,q)=>{let D={command:"resolve",path:u,key:e,pluginName:o};if(k!=null&&(D.pluginName=k),F!=null&&(D.importer=F),$!=null&&(D.namespace=$),R!=null&&(D.resolveDir=R),C!=null)D.kind=C;else throw new Error('Must specify "kind" when calling "resolve"');x!=null&&(D.pluginData=d.store(x)),O!=null&&(D.with=ft(O,"with")),t(i,D,(J,W)=>{J!==null?q(new Error(J)):U({errors:de(W.errors,d),warnings:de(W.warnings,d),path:W.path,external:W.external,sideEffects:W.sideEffects,namespace:W.namespace,suffix:W.suffix,pluginData:d.load(W.pluginData)})})})},onStart(u){let c='This error came from the "onStart" callback registered here:',h=be(new Error(c),a,"onStart");P.push({name:o,callback:u,note:h}),E.onStart=!0},onEnd(u){let c='This error came from the "onEnd" callback registered here:',h=be(new Error(c),a,"onEnd");A.push({name:o,callback:u,note:h}),E.onEnd=!0},onResolve(u,c){let h='This error came from the "onResolve" callback registered here:',k=be(new Error(h),a,"onResolve"),F={},$=r(u,F,"filter",Re),R=r(u,F,"namespace",m);if(K(u,F,`in onResolve() call for plugin ${_(o)}`),$==null)throw new Error("onResolve() call is missing a filter");let C=L++;b[C]={name:o,callback:c,note:k},E.onResolve.push({id:C,filter:xe($),namespace:R||""})},onLoad(u,c){let h='This error came from the "onLoad" callback registered here:',k=be(new Error(h),a,"onLoad"),F={},$=r(u,F,"filter",Re),R=r(u,F,"namespace",m);if(K(u,F,`in onLoad() call for plugin ${_(o)}`),$==null)throw new Error("onLoad() call is missing a filter");let C=L++;j[C]={name:o,callback:c,note:k},E.onLoad.push({id:C,filter:xe($),namespace:R||""})},onDispose(u){T.push(u)},esbuild:a.esbuild});B&&(yield B),S.push(E)}catch(v){return{ok:!1,error:v,pluginName:o}}}l["on-start"]=(p,f)=>te(null,null,function*(){d.clear();let o={errors:[],warnings:[]};yield Promise.all(P.map(B=>te(null,[B],function*({name:v,callback:E,note:M}){try{let u=yield E();if(u!=null){if(typeof u!="object")throw new Error(`Expected onStart() callback in plugin ${_(v)} to return an object`);let c={},h=r(u,c,"errors",le),k=r(u,c,"warnings",le);K(u,c,`from onStart() callback in plugin ${_(v)}`),h!=null&&o.errors.push(...se(h,"errors",d,v,void 0)),k!=null&&o.warnings.push(...se(k,"warnings",d,v,void 0))}}catch(u){o.errors.push(ae(u,a,d,M&&M(),v))}}))),n(p,o)}),l["on-resolve"]=(p,f)=>te(null,null,function*(){let o={},v="",E,M;for(let B of f.ids)try{({name:v,callback:E,note:M}=b[B]);let u=yield E({path:f.path,importer:f.importer,namespace:f.namespace,resolveDir:f.resolveDir,kind:f.kind,pluginData:d.load(f.pluginData),with:f.with});if(u!=null){if(typeof u!="object")throw new Error(`Expected onResolve() callback in plugin ${_(v)} to return an object`);let c={},h=r(u,c,"pluginName",m),k=r(u,c,"path",m),F=r(u,c,"namespace",m),$=r(u,c,"suffix",m),R=r(u,c,"external",I),C=r(u,c,"sideEffects",I),x=r(u,c,"pluginData",ve),O=r(u,c,"errors",le),U=r(u,c,"warnings",le),q=r(u,c,"watchFiles",Q),D=r(u,c,"watchDirs",Q);K(u,c,`from onResolve() callback in plugin ${_(v)}`),o.id=B,h!=null&&(o.pluginName=h),k!=null&&(o.path=k),F!=null&&(o.namespace=F),$!=null&&(o.suffix=$),R!=null&&(o.external=R),C!=null&&(o.sideEffects=C),x!=null&&(o.pluginData=d.store(x)),O!=null&&(o.errors=se(O,"errors",d,v,void 0)),U!=null&&(o.warnings=se(U,"warnings",d,v,void 0)),q!=null&&(o.watchFiles=we(q,"watchFiles")),D!=null&&(o.watchDirs=we(D,"watchDirs"));break}}catch(u){o={id:B,errors:[ae(u,a,d,M&&M(),v)]};break}n(p,o)}),l["on-load"]=(p,f)=>te(null,null,function*(){let o={},v="",E,M;for(let B of f.ids)try{({name:v,callback:E,note:M}=j[B]);let u=yield E({path:f.path,namespace:f.namespace,suffix:f.suffix,pluginData:d.load(f.pluginData),with:f.with});if(u!=null){if(typeof u!="object")throw new Error(`Expected onLoad() callback in plugin ${_(v)} to return an object`);let c={},h=r(u,c,"pluginName",m),k=r(u,c,"contents",qe),F=r(u,c,"resolveDir",m),$=r(u,c,"pluginData",ve),R=r(u,c,"loader",m),C=r(u,c,"errors",le),x=r(u,c,"warnings",le),O=r(u,c,"watchFiles",Q),U=r(u,c,"watchDirs",Q);K(u,c,`from onLoad() callback in plugin ${_(v)}`),o.id=B,h!=null&&(o.pluginName=h),k instanceof Uint8Array?o.contents=k:k!=null&&(o.contents=Z(k)),F!=null&&(o.resolveDir=F),$!=null&&(o.pluginData=d.store($)),R!=null&&(o.loader=R),C!=null&&(o.errors=se(C,"errors",d,v,void 0)),x!=null&&(o.warnings=se(x,"warnings",d,v,void 0)),O!=null&&(o.watchFiles=we(O,"watchFiles")),U!=null&&(o.watchDirs=we(U,"watchDirs"));break}}catch(u){o={id:B,errors:[ae(u,a,d,M&&M(),v)]};break}n(p,o)});let V=(p,f)=>f([],[]);A.length>0&&(V=(p,f)=>{te(null,null,function*(){let o=[],v=[];for(let{name:E,callback:M,note:B}of A){let u,c;try{let h=yield M(p);if(h!=null){if(typeof h!="object")throw new Error(`Expected onEnd() callback in plugin ${_(E)} to return an object`);let k={},F=r(h,k,"errors",le),$=r(h,k,"warnings",le);K(h,k,`from onEnd() callback in plugin ${_(E)}`),F!=null&&(u=se(F,"errors",d,E,void 0)),$!=null&&(c=se($,"warnings",d,E,void 0))}}catch(h){u=[ae(h,a,d,B&&B(),E)]}if(u){o.push(...u);try{p.errors.push(...u)}catch(h){}}if(c){v.push(...c);try{p.warnings.push(...c)}catch(h){}}}f(o,v)})});let w=()=>{for(let p of T)setTimeout(()=>p(),0)};return z=!0,{ok:!0,requestPlugins:S,runOnEndCallbacks:V,scheduleOnDisposeCallbacks:w}});function _e(){let e=new Map,t=0;return{clear(){e.clear()},load(n){return e.get(n)},store(n){if(n===void 0)return-1;let i=t++;return e.set(i,n),i}}}function be(e,t,n){let i,a=!1;return()=>{if(a)return i;a=!0;try{let l=(e.stack+"").split(`
