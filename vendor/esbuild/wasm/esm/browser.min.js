...
`;break;case 114:p+="\r";break;case 116:p+="	";break;case 117:{let y=0;for(let P=0;P<4;P++)m=e[o++],y<<=4,m>=48&&m<=57?y|=m-48:m>=97&&m<=102?y|=m+-87:m>=65&&m<=70?y|=m+-55:ee(e,--o);p+=le(y);break}default:ee(e,--o);break}else if(m<=127)p+=le(m);else if((m&224)===192)p+=le((m&31)<<6|e[o++]&63);else if((m&240)===224)p+=le((m&15)<<12|(e[o++]&63)<<6|e[o++]&63);else if((m&248)==240){let y=(m&7)<<18|(e[o++]&63)<<12|(e[o++]&63)<<6|e[o++]&63;y>65535&&(y-=65536,p+=le(y>>10&1023|55296),y=56320|y&1023),p+=le(y)}p[0];break}case 91:{p=[],t.push(l),n.push(s),i.push(f),l=null,s=p,f=1;continue}case 123:{p={},t.push(l),n.push(s),i.push(f),l=null,s=p,f=2;continue}case 93:{f!==1&&ee(e,--o),p=s,l=t.pop(),s=n.pop(),f=i.pop();break}case 125:{f!==2&&ee(e,--o),p=s,l=t.pop(),s=n.pop(),f=i.pop();break}default:ee(e,--o)}for(m=e[o];m<=32;)m=e[++o];switch(f){case 0:{if(o===u)return p;break}case 1:{if(s.push(p),m===44){o++;continue}if(m===93)continue;break}case 2:{if(l===null){if(l=p,m===58){o++;continue}}else{if(s[l]=p,l=null,m===44){o++;continue}if(m===125)continue}break}}break}ee(e,o)}var _=JSON.stringify,Le="warning",Ue="silent";function pe(e,t){let n=[];for(let i of e){if(Q(i,t),i.indexOf(",")>=0)throw new Error(`Invalid ${t}: ${i}`);n.push(i)}return n.join(",")}var ve=()=>null,I=e=>typeof e=="boolean"?null:"a boolean",b=e=>typeof e=="string"?null:"a string",Re=e=>e instanceof RegExp?null:"a RegExp object",ce=e=>typeof e=="number"&&e===(e|0)?null:"an integer",Ze=e=>typeof e=="number"&&e===(e|0)&&e>=0&&e<=65535?null:"a valid port number",je=e=>typeof e=="function"?null:"a function",oe=e=>Array.isArray(e)?null:"an array",Y=e=>Array.isArray(e)&&e.every(t=>typeof t=="string")?null:"an array of strings",G=e=>typeof e=="object"&&e!==null&&!Array.isArray(e)?null:"an object",et=e=>typeof e=="object"&&e!==null?null:"an array or an object",tt=e=>e instanceof WebAssembly.Module?null:"a WebAssembly.Module",Pe=e=>typeof e=="object"&&!Array.isArray(e)?null:"an object or null",Ne=e=>typeof e=="string"||typeof e=="boolean"?null:"a string or a boolean",nt=e=>typeof e=="string"||typeof e=="object"&&e!==null&&!Array.isArray(e)?null:"a string or an object",qe=e=>typeof e=="string"||Array.isArray(e)&&e.every(t=>typeof t=="string")?null:"a string or an array of strings",Ie=e=>typeof e=="string"||e instanceof Uint8Array?null:"a string or a Uint8Array",rt=e=>typeof e=="string"||e instanceof URL?null:"a string or a URL";function r(e,t,n,i){let u=e[n];if(t[n+""]=!0,u===void 0)return;let l=i(u);if(l!==null)throw new Error(`${_(n)} must be ${l}`);return u}function K(e,t,n){for(let i in e)if(!(i in t))throw new Error(`Invalid option ${n}: ${_(i)}`)}function We(e){let t=Object.create(null),n=r(e,t,"wasmURL",rt),i=r(e,t,"wasmModule",tt),u=r(e,t,"worker",I);return K(e,t,"in initialize() call"),{wasmURL:n,wasmModule:i,worker:u}}function ze(e){let t;if(e!==void 0){t=Object.create(null);for(let n in e){let i=e[n];if(typeof i=="string"||i===!1)t[n]=i;else throw new Error(`Expected ${_(n)} in mangle cache to map to either a string or false`)}}return t}function Se(e,t,n,i,u){let l=r(t,n,"color",I),f=r(t,n,"logLevel",b),s=r(t,n,"logLimit",ce),o=r(t,n,"logStyle",b);l!==void 0?e.push(`--color=${l}`):i&&e.push("--color=true"),e.push(`--log-level=${f||u}`),e.push(`--log-limit=${s||0}`),o&&e.push(`--log-style=${o}`)}function Q(e,t,n){if(typeof e!="string")throw new Error(`Expected value for ${t}${n!==void 0?" "+_(n):""} to be a string, got ${typeof e} instead`);return e}function Ke(e,t,n){let i=r(t,n,"legalComments",b),u=r(t,n,"sourceRoot",b),l=r(t,n,"sourcesContent",I),f=r(t,n,"target",qe),s=r(t,n,"format",b),o=r(t,n,"globalName",b),m=r(t,n,"mangleProps",Re),p=r(t,n,"reserveProps",Re),y=r(t,n,"mangleQuoted",I),P=r(t,n,"minify",I),L=r(t,n,"minifySyntax",I),T=r(t,n,"minifyWhitespace",I),j=r(t,n,"minifyIdentifiers",I),C=r(t,n,"lineLimit",ce),z=r(t,n,"drop",Y),V=r(t,n,"dropLabels",Y),R=r(t,n,"charset",b),h=r(t,n,"treeShaking",I),g=r(t,n,"ignoreAnnotations",I),a=r(t,n,"jsx",b),O=r(t,n,"jsxFactory",b),E=r(t,n,"jsxFragment",b),D=r(t,n,"jsxImportSource",b),k=r(t,n,"jsxDev",I),c=r(t,n,"jsxSideEffects",I),d=r(t,n,"define",G),x=r(t,n,"logOverride",G),A=r(t,n,"supported",G),F=r(t,n,"pure",Y),$=r(t,n,"keepNames",I),S=r(t,n,"platform",b),M=r(t,n,"tsconfigRaw",nt),q=r(t,n,"absPaths",Y);if(i&&e.push(`--legal-comments=${i}`),u!==void 0&&e.push(`--source-root=${u}`),l!==void 0&&e.push(`--sources-content=${l}`),f&&e.push(`--target=${pe(Array.isArray(f)?f:[f],"target")}`),s&&e.push(`--format=${s}`),o&&e.push(`--global-name=${o}`),S&&e.push(`--platform=${S}`),M&&e.push(`--tsconfig-raw=${typeof M=="string"?M:JSON.stringify(M)}`),P&&e.push("--minify"),L&&e.push("--minify-syntax"),T&&e.push("--minify-whitespace"),j&&e.push("--minify-identifiers"),C&&e.push(`--line-limit=${C}`),R&&e.push(`--charset=${R}`),h!==void 0&&e.push(`--tree-shaking=${h}`),g&&e.push("--ignore-annotations"),z)for(let w of z)e.push(`--drop:${Q(w,"drop")}`);if(V&&e.push(`--drop-labels=${pe(V,"drop label")}`),q&&e.push(`--abs-paths=${pe(q,"abs paths")}`),m&&e.push(`--mangle-props=${Oe(m)}`),p&&e.push(`--reserve-props=${Oe(p)}`),y!==void 0&&e.push(`--mangle-quoted=${y}`),a&&e.push(`--jsx=${a}`),O&&e.push(`--jsx-factory=${O}`),E&&e.push(`--jsx-fragment=${E}`),D&&e.push(`--jsx-import-source=${D}`),k&&e.push("--jsx-dev"),c&&e.push("--jsx-side-effects"),d)for(let w in d){if(w.indexOf("=")>=0)throw new Error(`Invalid define: ${w}`);e.push(`--define:${w}=${Q(d[w],"define",w)}`)}if(x)for(let w in x){if(w.indexOf("=")>=0)throw new Error(`Invalid log override: ${w}`);e.push(`--log-override:${w}=${Q(x[w],"log override",w)}`)}if(A)for(let w in A){if(w.indexOf("=")>=0)throw new Error(`Invalid supported: ${w}`);let B=A[w];if(typeof B!="boolean")throw new Error(`Expected value for supported ${_(w)} to be a boolean, got ${typeof B} instead`);e.push(`--supported:${w}=${B}`)}if(F)for(let w of F)e.push(`--pure:${Q(w,"pure")}`);$&&e.push("--keep-names")}function it(e,t,n,i,u){var ne;let l=[],f=[],s=Object.create(null),o=null,m=null;Se(l,t,s,n,i),Ke(l,t,s);let p=r(t,s,"sourcemap",Ne),y=r(t,s,"bundle",I),P=r(t,s,"splitting",I),L=r(t,s,"preserveSymlinks",I),T=r(t,s,"metafile",I),j=r(t,s,"outfile",b),C=r(t,s,"outdir",b),z=r(t,s,"outbase",b),V=r(t,s,"tsconfig",b),R=r(t,s,"resolveExtensions",Y),h=r(t,s,"nodePaths",Y),g=r(t,s,"mainFields",Y),a=r(t,s,"conditions",Y),O=r(t,s,"external",Y),E=r(t,s,"packages",b),D=r(t,s,"alias",G),k=r(t,s,"loader",G),c=r(t,s,"outExtension",G),d=r(t,s,"publicPath",b),x=r(t,s,"entryNames",b),A=r(t,s,"chunkNames",b),F=r(t,s,"assetNames",b),$=r(t,s,"inject",Y),S=r(t,s,"banner",G),M=r(t,s,"footer",G),q=r(t,s,"entryPoints",et),w=r(t,s,"absWorkingDir",b),B=r(t,s,"stdin",G),N=(ne=r(t,s,"write",I))!=null?ne:u,U=r(t,s,"allowOverwrite",I),J=r(t,s,"mangleCache",G);if(s.plugins=!0,K(t,s,`in ${e}() call`),p&&l.push(`--sourcemap${p===!0?"":`=${p}`}`),y&&l.push("--bundle"),U&&l.push("--allow-overwrite"),P&&l.push("--splitting"),L&&l.push("--preserve-symlinks"),T&&l.push("--metafile"),j&&l.push(`--outfile=${j}`),C&&l.push(`--outdir=${C}`),z&&l.push(`--outbase=${z}`),V&&l.push(`--tsconfig=${V}`),E&&l.push(`--packages=${E}`),R&&l.push(`--resolve-extensions=${pe(R,"resolve extension")}`),d&&l.push(`--public-path=${d}`),x&&l.push(`--entry-names=${x}`),A&&l.push(`--chunk-names=${A}`),F&&l.push(`--asset-names=${F}`),g&&l.push(`--main-fields=${pe(g,"main field")}`),a&&l.push(`--conditions=${pe(a,"condition")}`),O)for(let v of O)l.push(`--external:${Q(v,"external")}`);if(D)for(let v in D){if(v.indexOf("=")>=0)throw new Error(`Invalid package name in alias: ${v}`);l.push(`--alias:${v}=${Q(D[v],"alias",v)}`)}if(S)for(let v in S){if(v.indexOf("=")>=0)throw new Error(`Invalid banner file type: ${v}`);l.push(`--banner:${v}=${Q(S[v],"banner",v)}`)}if(M)for(let v in M){if(v.indexOf("=")>=0)throw new Error(`Invalid footer file type: ${v}`);l.push(`--footer:${v}=${Q(M[v],"footer",v)}`)}if($)for(let v of $)l.push(`--inject:${Q(v,"inject")}`);if(k)for(let v in k){if(v.indexOf("=")>=0)throw new Error(`Invalid loader extension: ${v}`);l.push(`--loader:${v}=${Q(k[v],"loader",v)}`)}if(c)for(let v in c){if(v.indexOf("=")>=0)throw new Error(`Invalid out extension: ${v}`);l.push(`--out-extension:${v}=${Q(c[v],"out extension",v)}`)}if(q)if(Array.isArray(q))for(let v=0,re=q.length;v<re;v++){let H=q[v];if(typeof H=="object"&&H!==null){let te=Object.create(null),ie=r(H,te,"in",b),X=r(H,te,"out",b);if(K(H,te,"in entry point at index "+v),ie===void 0)throw new Error('Missing property "in" for entry point at index '+v);if(X===void 0)throw new Error('Missing property "out" for entry point at index '+v);f.push([X,ie])}else f.push(["",Q(H,"entry point at index "+v)])}else for(let v in q)f.push([v,Q(q[v],"entry point",v)]);if(B){let v=Object.create(null),re=r(B,v,"contents",Ie),H=r(B,v,"resolveDir",b),te=r(B,v,"sourcefile",b),ie=r(B,v,"loader",b);K(B,v,'in "stdin" object'),te&&l.push(`--sourcefile=${te}`),ie&&l.push(`--loader=${ie}`),H&&(m=H),typeof re=="string"?o=Z(re):re instanceof Uint8Array&&(o=re)}let W=[];if(h)for(let v of h)v+="",W.push(v);return{entries:f,flags:l,write:N,stdinContents:o,stdinResolveDir:m,absWorkingDir:w,nodePaths:W,mangleCache:ze(J)}}function lt(e,t,n,i){let u=[],l=Object.create(null);Se(u,t,l,n,i),Ke(u,t,l);let f=r(t,l,"sourcemap",Ne),s=r(t,l,"sourcefile",b),o=r(t,l,"loader",b),m=r(t,l,"banner",b),p=r(t,l,"footer",b),y=r(t,l,"mangleCache",G);return K(t,l,`in ${e}() call`),f&&u.push(`--sourcemap=${f===!0?"external":f}`),s&&u.push(`--sourcefile=${s}`),o&&u.push(`--loader=${o}`),m&&u.push(`--banner=${m}`),p&&u.push(`--footer=${p}`),{flags:u,mangleCache:ze(y)}}function _e(e){let t={},n={didClose:!1,reason:""},i={},u=0,l=0,f=new Uint8Array(16*1024),s=0,o=R=>{let h=s+R.length;if(h>f.length){let a=new Uint8Array(h*2);a.set(f),f=a}f.set(R,s),s+=R.length;let g=0;for(;g+4<=s;){let a=Fe(f,g);if(g+4+a>s)break;g+=4,T(f.subarray(g,g+a)),g+=a}g>0&&(f.copyWithin(0,g,s),s-=g)},m=R=>{n.didClose=!0,R&&(n.reason=": "+(R.message||R));let h="The service was stopped"+n.reason;for(let g in i)i[g](h,null);i={}},p=(R,h,g)=>{if(n.didClose)return g("The service is no longer running"+n.reason,null);let a=u++;i[a]=(O,E)=>{try{g(O,E)}finally{R&&R.unref()}},R&&R.ref(),e.writeToStdin(De({id:a,isRequest:!0,value:h}))},y=(R,h)=>{if(n.didClose)throw new Error("The service is no longer running"+n.reason);e.writeToStdin(De({id:R,isRequest:!1,value:h}))},P=async(R,h)=>{try{if(h.command==="ping"){y(R,{});return}if(typeof h.key=="number"){let g=t[h.key];if(!g)return;let a=g[h.command];if(a){await a(R,h);return}}throw new Error("Invalid command: "+h.command)}catch(g){let a=[ue(g,e,null,void 0,"")];try{y(R,{errors:a})}catch(O){}}},L=!0,T=R=>{if(L){L=!1;let g=String.fromCharCode(...R);if(g!=="0.28.2")throw new Error(`Cannot start service: Host version "0.28.2" does not match binary version ${_(g)}`);return}let h=Me(R);if(h.isRequest)P(h.id,h.value);else{let g=i[h.id];delete i[h.id],h.value.error?g(h.value.error,{}):g(null,h.value)}};return{readFromStdout:o,afterClose:m,service:{buildOrContext:({callName:R,refs:h,options:g,isTTY:a,defaultWD:O,callback:E})=>{let D=0,k=l++,c={},d={ref(){++D===1&&h&&h.ref()},unref(){--D===0&&(delete t[k],h&&h.unref())}};t[k]=c,d.ref(),ot(R,k,p,y,d,e,c,g,a,O,(x,A)=>{try{E(x,A)}finally{d.unref()}})},transform:({callName:R,refs:h,input:g,options:a,isTTY:O,fs:E,callback:D})=>{let k=Ve(),c=d=>{try{if(typeof g!="string"&&!(g instanceof Uint8Array))throw new Error('The input to "transform" must be a string or a Uint8Array');let{flags:x,mangleCache:A}=lt(R,a,O,Ue),F={command:"transform",flags:x,inputFS:d!==null,input:d!==null?Z(d):typeof g=="string"?Z(g):g};A&&(F.mangleCache=A),p(h,F,($,S)=>{if($)return D(new Error($),null);let M=ge(S.errors,k),q=ge(S.warnings,k),w=1,B=()=>{if(--w===0){let N={warnings:q,code:S.code,map:S.map,mangleCache:void 0,legalComments:void 0};"legalComments"in S&&(N.legalComments=S==null?void 0:S.legalComments),S.mangleCache&&(N.mangleCache=S==null?void 0:S.mangleCache),D(null,N)}};if(M.length>0)return D(ye("Transform failed",M,q),null);S.codeFS&&(w++,E.readFile(S.code,(N,U)=>{N!==null?D(N,null):(S.code=U,B())})),S.mapFS&&(w++,E.readFile(S.map,(N,U)=>{N!==null?D(N,null):(S.map=U,B())})),B()})}catch(x){let A=[];try{Se(A,a,{},O,Ue)}catch($){}let F=ue(x,e,k,void 0,"");p(h,{command:"error",flags:A,error:F},()=>{F.detail=k.load(F.detail),D(ye("Transform failed",[F],[]),null)})}};if((typeof g=="string"||g instanceof Uint8Array)&&g.length>1024*1024){let d=c;c=()=>E.writeFile(g,d)}c(null)},formatMessages:({callName:R,refs:h,messages:g,options:a,callback:O})=>{if(!a)throw new Error(`Missing second argument in ${R}() call`);let E={},D=r(a,E,"kind",b),k=r(a,E,"color",I),c=r(a,E,"terminalWidth",ce),d=r(a,E,"logStyle",b);if(K(a,E,`in ${R}() call`),D===void 0)throw new Error(`Missing "kind" in ${R}() call`);if(D!=="error"&&D!=="warning")throw new Error(`Expected "kind" to be "error" or "warning" in ${R}() call`);let x={command:"format-msgs",messages:se(g,"messages",null,"",c),isWarning:D==="warning"};k!==void 0&&(x.color=k),c!==void 0&&(x.terminalWidth=c),d!==void 0&&(x.logStyle=d),p(h,x,(A,F)=>{if(A)return O(new Error(A),null);O(null,F.messages)})},analyzeMetafile:({callName:R,refs:h,metafile:g,options:a,callback:O})=>{a===void 0&&(a={});let E={},D=r(a,E,"color",I),k=r(a,E,"verbose",I);K(a,E,`in ${R}() call`);let c={command:"analyze-metafile",metafile:g};D!==void 0&&(c.color=D),k!==void 0&&(c.verbose=k),p(h,c,(d,x)=>{if(d)return O(new Error(d),null);O(null,x.result)})}}}}function ot(e,t,n,i,u,l,f,s,o,m,p){let y=Ve(),P=e==="context",L=(C,z)=>{let V=[];try{Se(V,s,{},o,Le)}catch(h){}let R=ue(C,l,y,void 0,z);n(u,{command:"error",flags:V,error:R},()=>{R.detail=y.load(R.detail),p(ye(P?"Context failed":"Build failed",[R],[]),null)})},T;if(typeof s=="object"){let C=s.plugins;if(C!==void 0){if(!Array.isArray(C))return L(new Error('"plugins" must be an array'),"");T=C}}if(T&&T.length>0){if(l.isSync)return L(new Error("Cannot use plugins in synchronous API calls"),"");st(t,n,i,u,l,f,s,T,y).then(C=>{if(!C.ok)return L(C.error,C.pluginName);try{j(C.requestPlugins,C.runOnEndCallbacks,C.scheduleOnDisposeCallbacks)}catch(z){L(z,"")}},C=>L(C,""));return}try{j(null,(C,z)=>z([],[]),()=>{})}catch(C){L(C,"")}function j(C,z,V){let R=l.hasFS,{entries:h,flags:g,write:a,stdinContents:O,stdinResolveDir:E,absWorkingDir:D,nodePaths:k,mangleCache:c}=it(e,s,o,Le,R);if(a&&!l.hasFS)throw new Error('The "write" option is unavailable in this environment');let d={command:"build",key:t,entries:h,flags:g,write:a,stdinContents:O,stdinResolveDir:E,absWorkingDir:D||m,nodePaths:k,context:P};C&&(d.plugins=C),c&&(d.mangleCache=c);let x=($,S)=>{let M={errors:ge($.errors,y),warnings:ge($.warnings,y),outputFiles:void 0,metafile:void 0,mangleCache:void 0},q=M.errors.slice(),w=M.warnings.slice();$.outputFiles&&(M.outputFiles=$.outputFiles.map(ut)),$.metafile&&$.metafile.length&&(M.metafile=ct($.metafile)),$.mangleCache&&(M.mangleCache=$.mangleCache),$.writeToStdout!==void 0&&console.log(ae($.writeToStdout).replace(/\n$/,"")),z(M,(B,N)=>{if(q.length>0||B.length>0){let U=ye("Build failed",q.concat(B),w.concat(N));return S(U,null,B,N)}S(null,M,B,N)})},A,F;P&&(f["on-end"]=($,S)=>new Promise(M=>{x(S,(q,w,B,N)=>{let U={errors:B,warnings:N};F&&F(q,w),A=void 0,F=void 0,i($,U),M()})})),n(u,d,($,S)=>{if($)return p(new Error($),null);if(!P)return x(S,(w,B)=>(V(),p(w,B)));if(S.errors.length>0)return p(ye("Context failed",S.errors,S.warnings),null);let M=!1,q={rebuild:()=>(A||(A=new Promise((w,B)=>{let N;F=(J,W)=>{N||(N=()=>J?B(J):w(W))};let U=()=>{n(u,{command:"rebuild",key:t},(W,ne)=>{W?B(new Error(W)):N?N():U()})};U()})),A),watch:(w={})=>new Promise((B,N)=>{if(!l.hasFS)throw new Error('Cannot use the "watch" API in this environment');let U={},J=r(w,U,"delay",ce);K(w,U,"in watch() call");let W={command:"watch",key:t};J&&(W.delay=J),n(u,W,ne=>{ne?N(new Error(ne)):B(void 0)})}),serve:(w={})=>new Promise((B,N)=>{if(!l.hasFS)throw new Error('Cannot use the "serve" API in this environment');let U={},J=r(w,U,"port",Ze),W=r(w,U,"host",b),ne=r(w,U,"servedir",b),v=r(w,U,"keyfile",b),re=r(w,U,"certfile",b),H=r(w,U,"fallback",b),te=r(w,U,"cors",G),ie=r(w,U,"onRequest",je);K(w,U,"in serve() call");let X={command:"serve",key:t,onRequest:!!ie};if(J!==void 0&&(X.port=J),W!==void 0&&(X.host=W),ne!==void 0&&(X.servedir=ne),v!==void 0&&(X.keyfile=v),re!==void 0&&(X.certfile=re),H!==void 0&&(X.fallback=H),te){let me={},de=r(te,me,"origin",qe);K(te,me,'on "cors" object'),Array.isArray(de)?X.corsOrigin=de:de!==void 0&&(X.corsOrigin=[de])}n(u,X,(me,de)=>{if(me)return N(new Error(me));ie&&(f["serve-request"]=(Qe,Ye)=>{ie(Ye.args),i(Qe,{})}),B(de)})}),cancel:()=>new Promise(w=>{if(M)return w();n(u,{command:"cancel",key:t},()=>{w()})}),dispose:()=>new Promise(w=>{if(M)return w();M=!0,n(u,{command:"dispose",key:t},()=>{w(),V(),u.unref()})})};u.ref(),p(null,q)})}}var st=async(e,t,n,i,u,l,f,s,o)=>{let m=[],p=[],y={},P={},L=[],T=0,j=0,C=[],z=!1;s=[...s];for(let h of s){let g={};if(typeof h!="object")throw new Error(`Plugin at index ${j} must be an object`);let a=r(h,g,"name",b);if(typeof a!="string"||a==="")throw new Error(`Plugin at index ${j} is missing a name`);try{let O=r(h,g,"setup",je);if(typeof O!="function")throw new Error("Plugin is missing a setup function");K(h,g,`on plugin ${_(a)}`);let E={name:a,onStart:!1,onEnd:!1,onResolve:[],onLoad:[]};j++;let k=O({initialOptions:f,resolve:(c,d={})=>{if(!z)throw new Error('Cannot call "resolve" before plugin setup has completed');if(typeof c!="string")throw new Error("The path to resolve must be a string");let x=Object.create(null),A=r(d,x,"pluginName",b),F=r(d,x,"importer",b),$=r(d,x,"namespace",b),S=r(d,x,"resolveDir",b),M=r(d,x,"kind",b),q=r(d,x,"pluginData",ve),w=r(d,x,"with",G);return K(d,x,"in resolve() call"),new Promise((B,N)=>{let U={command:"resolve",path:c,key:e,pluginName:a};if(A!=null&&(U.pluginName=A),F!=null&&(U.importer=F),$!=null&&(U.namespace=$),S!=null&&(U.resolveDir=S),M!=null)U.kind=M;else throw new Error('Must specify "kind" when calling "resolve"');q!=null&&(U.pluginData=o.store(q)),w!=null&&(U.with=at(w,"with")),t(i,U,(J,W)=>{J!==null?N(new Error(J)):B({errors:ge(W.errors,o),warnings:ge(W.warnings,o),path:W.path,external:W.external,sideEffects:W.sideEffects,namespace:W.namespace,suffix:W.suffix,pluginData:o.load(W.pluginData)})})})},onStart(c){let d='This error came from the "onStart" callback registered here:',x=be(new Error(d),u,"onStart");m.push({name:a,callback:c,note:x}),E.onStart=!0},onEnd(c){let d='This error came from the "onEnd" callback registered here:',x=be(new Error(d),u,"onEnd");p.push({name:a,callback:c,note:x}),E.onEnd=!0},onResolve(c,d){let x='This error came from the "onResolve" callback registered here:',A=be(new Error(x),u,"onResolve"),F={},$=r(c,F,"filter",Re),S=r(c,F,"namespace",b);if(K(c,F,`in onResolve() call for plugin ${_(a)}`),$==null)throw new Error("onResolve() call is missing a filter");let M=T++;y[M]={name:a,callback:d,note:A},E.onResolve.push({id:M,filter:Oe($),namespace:S||""})},onLoad(c,d){let x='This error came from the "onLoad" callback registered here:',A=be(new Error(x),u,"onLoad"),F={},$=r(c,F,"filter",Re),S=r(c,F,"namespace",b);if(K(c,F,`in onLoad() call for plugin ${_(a)}`),$==null)throw new Error("onLoad() call is missing a filter");let M=T++;P[M]={name:a,callback:d,note:A},E.onLoad.push({id:M,filter:Oe($),namespace:S||""})},onDispose(c){L.push(c)},esbuild:u.esbuild});k&&await k,C.push(E)}catch(O){return{ok:!1,error:O,pluginName:a}}}l["on-start"]=async(h,g)=>{o.clear();let a={errors:[],warnings:[]};await Promise.all(m.map(async({name:O,callback:E,note:D})=>{try{let k=await E();if(k!=null){if(typeof k!="object")throw new Error(`Expected onStart() callback in plugin ${_(O)} to return an object`);let c={},d=r(k,c,"errors",oe),x=r(k,c,"warnings",oe);K(k,c,`from onStart() callback in plugin ${_(O)}`),d!=null&&a.errors.push(...se(d,"errors",o,O,void 0)),x!=null&&a.warnings.push(...se(x,"warnings",o,O,void 0))}}catch(k){a.errors.push(ue(k,u,o,D&&D(),O))}})),n(h,a)},l["on-resolve"]=async(h,g)=>{let a={},O="",E,D;for(let k of g.ids)try{({name:O,callback:E,note:D}=y[k]);let c=await E({path:g.path,importer:g.importer,namespace:g.namespace,resolveDir:g.resolveDir,kind:g.kind,pluginData:o.load(g.pluginData),with:g.with});if(c!=null){if(typeof c!="object")throw new Error(`Expected onResolve() callback in plugin ${_(O)} to return an object`);let d={},x=r(c,d,"pluginName",b),A=r(c,d,"path",b),F=r(c,d,"namespace",b),$=r(c,d,"suffix",b),S=r(c,d,"external",I),M=r(c,d,"sideEffects",I),q=r(c,d,"pluginData",ve),w=r(c,d,"errors",oe),B=r(c,d,"warnings",oe),N=r(c,d,"watchFiles",Y),U=r(c,d,"watchDirs",Y);K(c,d,`from onResolve() callback in plugin ${_(O)}`),a.id=k,x!=null&&(a.pluginName=x),A!=null&&(a.path=A),F!=null&&(a.namespace=F),$!=null&&(a.suffix=$),S!=null&&(a.external=S),M!=null&&(a.sideEffects=M),q!=null&&(a.pluginData=o.store(q)),w!=null&&(a.errors=se(w,"errors",o,O,void 0)),B!=null&&(a.warnings=se(B,"warnings",o,O,void 0)),N!=null&&(a.watchFiles=xe(N,"watchFiles")),U!=null&&(a.watchDirs=xe(U,"watchDirs"));break}}catch(c){a={id:k,errors:[ue(c,u,o,D&&D(),O)]};break}n(h,a)},l["on-load"]=async(h,g)=>{let a={},O="",E,D;for(let k of g.ids)try{({name:O,callback:E,note:D}=P[k]);let c=await E({path:g.path,namespace:g.namespace,suffix:g.suffix,pluginData:o.load(g.pluginData),with:g.with});if(c!=null){if(typeof c!="object")throw new Error(`Expected onLoad() callback in plugin ${_(O)} to return an object`);let d={},x=r(c,d,"pluginName",b),A=r(c,d,"contents",Ie),F=r(c,d,"resolveDir",b),$=r(c,d,"pluginData",ve),S=r(c,d,"loader",b),M=r(c,d,"errors",oe),q=r(c,d,"warnings",oe),w=r(c,d,"watchFiles",Y),B=r(c,d,"watchDirs",Y);K(c,d,`from onLoad() callback in plugin ${_(O)}`),a.id=k,x!=null&&(a.pluginName=x),A instanceof Uint8Array?a.contents=A:A!=null&&(a.contents=Z(A)),F!=null&&(a.resolveDir=F),$!=null&&(a.pluginData=o.store($)),S!=null&&(a.loader=S),M!=null&&(a.errors=se(M,"errors",o,O,void 0)),q!=null&&(a.warnings=se(q,"warnings",o,O,void 0)),w!=null&&(a.watchFiles=xe(w,"watchFiles")),B!=null&&(a.watchDirs=xe(B,"watchDirs"));break}}catch(c){a={id:k,errors:[ue(c,u,o,D&&D(),O)]};break}n(h,a)};let V=(h,g)=>g([],[]);p.length>0&&(V=(h,g)=>{(async()=>{let a=[],O=[];for(let{name:E,callback:D,note:k}of p){let c,d;try{let x=await D(h);if(x!=null){if(typeof x!="object")throw new Error(`Expected onEnd() callback in plugin ${_(E)} to return an object`);let A={},F=r(x,A,"errors",oe),$=r(x,A,"warnings",oe);K(x,A,`from onEnd() callback in plugin ${_(E)}`),F!=null&&(c=se(F,"errors",o,E,void 0)),$!=null&&(d=se($,"warnings",o,E,void 0))}}catch(x){c=[ue(x,u,o,k&&k(),E)]}if(c){a.push(...c);try{h.errors.push(...c)}catch(x){}}if(d){O.push(...d);try{h.warnings.push(...d)}catch(x){}}}g(a,O)})()});let R=()=>{for(let h of L)setTimeout(()=>h(),0)};return z=!0,{ok:!0,requestPlugins:C,runOnEndCallbacks:V,scheduleOnDisposeCallbacks:R}};function Ve(){let e=new Map,t=0;return{clear(){e.clear()},load(n){return e.get(n)},store(n){if(n===void 0)return-1;let i=t++;return e.set(i,n),i}}}function be(e,t,n){let i,u=!1;return()=>{if(u)return i;u=!0;try{let l=(e.stack+"").split(`
