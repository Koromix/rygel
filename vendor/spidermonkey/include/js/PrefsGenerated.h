...
#define JS_PREF_CLASS_FIELDS \
  ...
  static bool experimental_async_iterator_helpers_;\
  static bool experimental_float16array_;\
  static bool experimental_iterator_helpers_;\
  static bool experimental_json_parse_with_source_;\
  ...
  static bool experimental_symbols_as_weakmap_keys_;\
  ...
  static bool wasm_experimental_compile_pipeline_;\
...
#define JS_PREF_CLASS_FIELDS_INIT \
  ...
  bool JS::Prefs::experimental_async_iterator_helpers_{false};\
  bool JS::Prefs::experimental_float16array_{true};\
  bool JS::Prefs::experimental_iterator_helpers_{false};\
  bool JS::Prefs::experimental_json_parse_with_source_{false};\
  ...
  bool JS::Prefs::experimental_symbols_as_weakmap_keys_{false};\
  bool JS::Prefs::experimental_uint8array_base64_{false};\
  bool JS::Prefs::experimental_weakrefs_expose_cleanupSome_{false};\
  bool JS::Prefs::extra_gc_poisoning_{false};\
  ...
  bool JS::Prefs::wasm_tail_calls_{false};\
...
#define FOR_EACH_JS_PREF(MACRO) \
  ...
  MACRO("experimental.async_iterator_helpers", experimental_async_iterator_helpers, bool, setAtStartup_experimental_async_iterator_helpers, true)\
  MACRO("experimental.float16array", experimental_float16array, bool, setAtStartup_experimental_float16array, true)\
  MACRO("experimental.iterator_helpers", experimental_iterator_helpers, bool, setAtStartup_experimental_iterator_helpers, true)\
  MACRO("experimental.json_parse_with_source", experimental_json_parse_with_source, bool, setAtStartup_experimental_json_parse_with_source, true)\
  ...
  MACRO("experimental.symbols_as_weakmap_keys", experimental_symbols_as_weakmap_keys, bool, setAtStartup_experimental_symbols_as_weakmap_keys, true)\
  ...
  MACRO("wasm_experimental_compile_pipeline", wasm_experimental_compile_pipeline, bool, setAtStartup_wasm_experimental_compile_pipeline, true)\
...
#define SET_JS_PREFS_FROM_BROWSER_PREFS \
  ...
  JS::Prefs::setAtStartup_experimental_async_iterator_helpers(mozilla::StaticPrefs::javascript_options_experimental_async_iterator_helpers());\
  JS::Prefs::setAtStartup_experimental_float16array(mozilla::StaticPrefs::javascript_options_experimental_float16array());\
  JS::Prefs::setAtStartup_experimental_iterator_helpers(mozilla::StaticPrefs::javascript_options_experimental_iterator_helpers());\
  JS::Prefs::setAtStartup_experimental_json_parse_with_source(mozilla::StaticPrefs::javascript_options_experimental_json_parse_with_source());\
  ...
  JS::Prefs::setAtStartup_experimental_symbols_as_weakmap_keys(mozilla::StaticPrefs::javascript_options_experimental_symbols_as_weakmap_keys());\
  ...
  JS::Prefs::setAtStartup_wasm_experimental_compile_pipeline(mozilla::StaticPrefs::javascript_options_wasm_experimental_compile_pipeline());\
